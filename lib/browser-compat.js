...
const browserAPI_exists = (typeof self !== "undefined" && self.browserAPI) || 
  ...
  storage: {
    ...
    sync: hasStorageSync
      ? {
          ...
          getBytesInUse: isChrome
            ? promisify(chrome.storage.sync.getBytesInUse, chrome.storage.sync)
  ...
  action: hasAction
    ? {
        ...
        setBadgeText: isChrome
          ? promisify(chrome.action?.setBadgeText || (() => {}), chrome.action)
